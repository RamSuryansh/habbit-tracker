...
import { CATEGORIES, COLORS, EMOJIS, DAY_LABELS } from '@/utils/constants'
...
export default function HabitForm({ open, onClose, editingHabit }: HabitFormProps) {
